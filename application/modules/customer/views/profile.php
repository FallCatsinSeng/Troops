              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="profile">
                    <?php echo form_open_multipart('customer/profile/edit_name', array('enctype' => 'multipart/form-data')); ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputProvinsi" name="provinsi" value="<?php echo set_value('provinsi', $user->provinsi); ?>" required>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputKabupaten" name="kabupaten" value="<?php echo set_value('kabupaten', $user->kabupaten); ?>" required>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputKecamatan" name="kecamatan" value="<?php echo set_value('kecamatan', $user->kecamatan); ?>" required>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputDesa" name="desa" value="<?php echo set_value('desa', $user->desa); ?>" required>
                        </div>
                        <?php echo form_error('desa', '<div class="text-danger font-weight-bold">', '</div>'); ?>
                      </div>
                      <div class="form-group row">
                        <label for="inputAddr" class="col-sm-2 col-form-label">Alamat Lengkap:</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputKodePos" name="kode_pos" value="<?php echo set_value('kode_pos', $user->kode_pos); ?>" required>
                        </div>
                        <?php echo form_error('kode_pos', '<div class="text-danger font-weight-bold">', '</div>'); ?>
                      </div>
                      <div class="form-group row">
