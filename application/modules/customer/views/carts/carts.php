                                    ...
                                    <?php foreach ($carts as $item) : ?>
                                        <tr class="text-center cart-<?php echo $item['rowid']; ?>">
                                            <td class="product-remove">
                                                <a href="#" class="remove-item" data-rowid="<?php echo $item['rowid']; ?>">
                                            ...
                                            <td class="quantity">
                                                <div class="input-groupp mb-3">
                                                    <input type="text" name="quantity[<?php echo $item['rowid']; ?>]" class="quantity form-controll input-number" value="<?php echo $item['qty']; ?>" min="1" max="100">
                                                </div>
                                            </td>
            ...
            <div class="row">
                <div class="col-md-12 ftco-animate">
                    <div class="alert alert-info">Tidak ada barang dalam keranjang.
                        <br>
                        <?php echo anchor('home', 'Jelajahi produk kami', ['class' => 'ab']); ?> dan mulailah berbelanja!
                    </div>
                </div>
            </div>
        <?php endif; ?>
