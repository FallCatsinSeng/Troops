...
<body class="@yield('sidebar_type')">
    ...
    <a class="nav-link" href="<?php echo site_url('admin/videos'); ?>">
        ...
        <span class="nav-link-text">Tambah Video</span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="nav-orders" href="<?php echo site_url('admin/orders'); ?>">
...
$(document).ready(function() {
    ...
    $("#nav-orders").click(function(e) {
        ...
        // Tampilkan loading di link
        const $link = $(this);
        const originalContent = $link.html();
        $link.html('<i class="fa fa-spinner fa-spin"></i> Memperbarui Status...');
