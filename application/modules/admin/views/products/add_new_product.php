      ...
      <div class="row">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input type="text" name="price_discount" value="<?php echo set_value('price_discount'); ?>" class="form-control" id="price_d">
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="weight" value="<?php echo set_value('weight'); ?>" class="form-control" id="unit">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label class="form-control-label" for="pic">Foto Produk (2-3 foto):</label>
                        <input type="file" name="pictures[]" class="form-control" id="pic" multiple accept="image/*" required>
                        <small class="text-muted">Pilih minimal 2 dan maksimal 3 foto PNG atau JPG dengan ukuran maksimal 2MB per foto</small>
...
document.getElementById('pic').addEventListener('change', function(e) {
    ...
    if (this.files.length < 2) {
        alert('Minimal 2 foto harus dipilih');
        this.value = '';
        return;
    }
